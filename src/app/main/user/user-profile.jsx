            ...
            <div className="sd-header-modern">
                ...
                <div className="sd-info-modern">
                    ...
                    <div className="sd-cta-modern">
                        {/* <button className="btn-gradient" onClick={() => Handler("call", x._id)}>{IconsReact.Call} {cost?.call}/min</button>
                        <button className="btn-gradient" onClick={() => Handler("chat", x._id)}>{IconsReact.Chat} {cost?.chat}/msg</button>
                        <button className="btn-gradient" onClick={() => Handler("v-call", x._id)}>{IconsReact.Video} {cost?.vcall}/min</button>
                        <button className="btn-gradient" onClick={() => Handler("gift", x._id)}>{IconsReact.Gift} Send Gift</button> */}
